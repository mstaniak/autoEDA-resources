...
Undoubtely, the presented have many advantages.
...
## Strengths 
  ...
  * For datasets with a moderate number of features, `DataExplorer`, `funModeling` and `dlookr` give a reasonable insight into variables stributions and simple relationships.
...
## Weaknesses
  ...
  * None of the packages addresses issues such a multicolinearity.
